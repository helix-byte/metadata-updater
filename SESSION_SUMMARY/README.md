...
### 会话 3：项目结构分析与功能重构 (2026-02-03)
- **文件**: `SESSION_2026-02-03_PROJECT_REFACTOR.md`
- **版本**: v0.1.2 → v0.2.0 → v0.3.0
- **主要任务**:
  - 全面探索项目目录结构
  - 分析核心配置文件
  - 梳理源代码组织方式
...
### 开发文档
- **[项目结构分析](PROJECT_STRUCTURE.md)** - 完整的项目目录结构、配置文件说明、源代码组织方式
- **[变更日志](CHANGELOG.md)** - 详细的代码变更记录
- **[代码片段](CODE_SNIPPETS.md)** - 常用代码片段和示例
- **[关键学习点](KEY_LEARNINGS.md)** - 开发过程中的重要知识点
- **[提示词记录](Prompts.md)** - LLM交互提示词记录

### 会话记录
- **[会话1：完整开发流程](SESSION_2024-02-02_FULL_DEVELOPMENT.md)** - v0.1.0 → v0.1.1
- **[会话2：LLM关键词提取集成](SESSION_2024-02-02_LLM_INTEGRATION.md)** - v0.1.1 → v0.1.2
